...
// services/audit/src/common/audit.interceptor.ts
//
// NO-OP version for the Audit Service itself.
// The Audit Service persists directly to DB — it must NOT call
// itself via HTTP or it will loop indefinitely.
// All other 12 services use the full version.
// ============================================================
import {
...
const SKIP_PATHS = new Set([
  ...
  // Audit service self-protection: never fire a log for its own inbound requests
  '/api/v1/audit/logs',
...
export class AuditInterceptor implements NestInterceptor {
  ...
  intercept(context: ExecutionContext, next: CallHandler): Observable<unknown> {
    // Audit service is its own sink — never self-log
